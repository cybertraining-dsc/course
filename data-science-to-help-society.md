...
-   Introduction to Tensorflow [PPTX](https://drive.google.com/file/d/1Iv_b_WqV2ovPhanh2ab_yhmYgo_VQSxN/view?usp=sharing)

-   **Introduction to using Colab** from IU class E534 with videos and
    note
    <https://docs.google.com/document/d/1KT3KHgV-jEIfnLSfI772kdKaFdXoiyAGjyLfU1TpzDA/edit?usp=sharing>
...
-   **Deep Learning for MNIST** The docs are located alongside the video at
    ...
    -   <https://docs.google.com/document/d/1E8orgHbNV6P8STl2lQxov2VHKSYyIISSj-XfsvQlRX4/edit?usp=sharing>
    ...
    -   [DNN MNIST Introduction, Part 1 (mp4)](https://drive.google.com/open?id=1NQnrWboSI2kc38uTgd3OtFQkK44L5jZP)

    -   [DNN MNIST Introduction, Part 2 (mp4)](https://drive.google.com/open?id=165fvbfdrrsUznzyO_ulPyKhn6Xtopgtv)
        
        - Running into import errors starting at the keras.models line in the code

    -   [DNN MNIST data preprocessing Part 3 (mp4)](https://drive.google.com/open?id=1_K--i9O2QioJ7SVOKgd4NmV71yvSDRcj)

    -   [DNN MNIST model definition, Part 4 (mp4)](https://drive.google.com/open?id=1pb11xVSv3lSY1sSefTSfVGmdYkzli8Ij)
...
- Class on AI First Engineering with 35 videos describing technologies
  ...
  Space, Energy in
  detail <https://www.youtube.com/playlist?list=PLy0VLh_GFyz_znIuyPaaSNteZsCJmw4vt>

- Introductory Video (one of 35) discussing the Transformation -
  Industries invented and remade through AI
  <https://www.youtube.com/watch?v=h6U3dcNbc-E&list=PLy0VLh_GFyz_znIuyPaaSNteZsCJmw4vt&index=2&t=6s>
...
[Medical Student COVID-19 Curriculum - COVID-19 Curriculum](https://curriculum.covidstudentresponse.org/) Module 1
and then module 2
...
Manual:
<https://pythonscriptingmanual.readthedocs.io/en/4.1.1/>

List of NanoHub Tools:
<https://compucell3d.org/Models>

Need help. Please ask [Juliano Ferrari Gianlupi](mailto:julianoferrarigianlupi@gmail.com)
...
Infection, Viral Spread and Immune Response and Treatment Regimes](https://compucell3d.org/VTcovid19Symp)
...
-   Data Science [[R5]](#R5), [[R6]](#R6), and [[R7]](#R7)

-   Modeling [[R8]](#R8) and [[R9]](#R9)
